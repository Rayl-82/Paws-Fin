  ...
  return (
    <div className="min-h-screen bg-[#F7F9FC] font-sans text-[#1A1A1A] flex flex-col relative">
      ...
      <main className="w-full flex flex-col flex-grow">
        {/* SECTION 1 - HERO */}
        <section className="relative w-full h-[750px] lg:h-[850px] flex items-center">
          {/* Background Image */}
          ...
          <div className="relative z-10 w-full max-w-7xl px-4 md:px-8 lg:px-16 mx-auto">
            <div className="max-w-2xl text-left">
              <span className="text-[#F26641] font-semibold text-sm tracking-widest uppercase mb-4 block">
              ...
              <p className="text-gray-200 text-lg md:text-xl mb-10 max-w-lg leading-relaxed">
                We transform underused marine resources into nutritious treats and supplements that support healthier pets while reducing food waste.
              </p>

              <div className="flex flex-col sm:flex-row gap-4">
                <Link href="/shop/products" className="bg-[#F26641] hover:bg-[#BF4A28] text-white font-semibold py-4 px-8 rounded-xl flex justify-center items-center gap-2 transition-all shadow-md hover:-translate-y-1">
                  Explore Products
                  <ArrowRight size={20} />
                </Link>
                <Link href="/shop/personalized" className="bg-white hover:bg-gray-50 text-[#1B6CA8] font-semibold py-4 px-8 rounded-xl flex justify-center items-center transition-all shadow-md hover:-translate-y-1">
                  Take The Quiz
                </Link>
              </div>
            </div>
        ...
        <section className="w-full bg-[#F7F9FC] py-20 lg:py-32">
          <div className="w-full max-w-7xl mx-auto px-4 md:px-8 lg:px-16 flex flex-col gap-24">
            ...
            <div className="flex flex-col lg:flex-row gap-16 lg:gap-24 items-center">
              ...
              <div className="flex-1 flex flex-col max-w-xl">
                <h2 className="text-[#0C3350] text-4xl lg:text-5xl font-bold font-serif mb-6 leading-tight">
                  Guided by Nature,<br />Powered by the Sea
                </h2>
                <ul className="text-[#0C3350] font-medium space-y-4 mb-8 text-lg">
          ...
          <div className="w-full max-w-7xl mx-auto px-4 md:px-8 lg:px-16 flex flex-col items-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8 w-full">
              {[
                ...
                <div key={idx} className="bg-[#FFFFFF] rounded-2xl p-8 shadow-sm border border-[#F0F4F8] flex flex-col items-center text-center hover:shadow-md transition-shadow">
                  <div className="w-14 h-14 bg-[#D6E8F5] text-[#1B6CA8] rounded-2xl flex items-center justify-center mb-6">
        ...
        <section className="w-full bg-[#F7F9FC] py-20 lg:py-24 border-y border-[#E2E8F0]">
          <div className="w-full max-w-7xl mx-auto px-4 md:px-8 lg:px-16 flex flex-col items-center">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-12 w-full text-center">
              {[
                ...
                <div key={idx} className="flex flex-col items-center">
                  <div className="text-[#1B6CA8] text-5xl font-bold font-serif mb-3">
                    {stat.value}
                  </div>
                  <div className="text-[#546E7A] text-base font-medium uppercase tracking-wide">
                    {stat.label}
                  </div>
                </div>
              ))}
        ...
        <section className="w-full bg-[#124E7A] py-20 lg:py-24 text-white">
          <div className="w-full max-w-7xl mx-auto px-4 md:px-8 lg:px-16 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="flex flex-col justify-center bg-[#0C3350] p-8 md:p-12 rounded-2xl shadow-xl border border-[#1B6CA8]/30">
              <h3 className="text-2xl font-bold font-serif mb-8 text-white">Nutritional Standards</h3>
        ...
        <div className="w-full bg-[#F26641] py-4 overflow-hidden flex whitespace-nowrap">
          <div className="animate-marquee inline-block font-bold text-white tracking-widest text-sm uppercase px-4 flex items-center">
          ...
          <div className="animate-marquee inline-block font-bold text-white tracking-widest text-sm uppercase px-4 flex items-center" aria-hidden="true">
            <span className="mx-8">HEALTHY PETS</span><span className="w-1.5 h-1.5 rounded-full bg-white opacity-50"></span>
            <span className="mx-8">SUSTAINABLE OCEAN</span><span className="w-1.5 h-1.5 rounded-full bg-white opacity-50"></span>
            <span className="mx-8">PREMIUM NUTRITION</span><span className="w-1.5 h-1.5 rounded-full bg-white opacity-50"></span>
            <span className="mx-8">CIRCULAR ECONOMY</span><span className="w-1.5 h-1.5 rounded-full bg-white opacity-50"></span>
        ...
        <section className="w-full bg-[#F7F9FC] py-20 lg:py-32">
          <div className="w-full max-w-7xl mx-auto px-4 md:px-8 lg:px-16 flex flex-col items-center">
            ...
            {/* Changed flex layout so heights stretch to match */}
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 w-full items-stretch">

              {/* Card 1 - Shop */}
              <div className="bg-white rounded-2xl border-2 border-transparent hover:border-[#D6E8F5] flex flex-col overflow-hidden shadow-sm hover:shadow-md transition-all duration-300 group">
                ...
                <div className="p-8 flex flex-col flex-grow">
                  <h3 className="text-[#191C1E] text-2xl font-bold font-serif mb-4 group-hover:text-[#1B6CA8] transition-colors">Shop Premium Nutrition</h3>
                  <p className="text-[#414750] text-base mb-8 flex-grow">
              ...
              <div className="bg-white rounded-2xl border-2 border-[#F26641] flex flex-col overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 group relative">
                <div className="absolute top-0 left-0 w-full h-8 bg-[#F26641] text-white text-xs font-bold uppercase tracking-wider flex items-center justify-center z-20">
                  Recommended For New Pets
                </div>
                <div className="w-full h-56 relative bg-[#FDDDD5] flex items-center justify-center mt-8 overflow-hidden z-10">
                ...
                <div className="p-8 flex flex-col flex-grow">
                  <h3 className="text-[#191C1E] text-2xl font-bold font-serif mb-4 group-hover:text-[#F26641] transition-colors">Build Pet Profile</h3>
                  <p className="text-[#414750] text-base mb-8 flex-grow">
              ...
              <div className="bg-white rounded-2xl border-2 border-transparent hover:border-[#D6E8F5] flex flex-col overflow-hidden shadow-sm hover:shadow-md transition-all duration-300 group">
                ...
                <div className="p-8 flex flex-col flex-grow">
                  <h3 className="text-[#191C1E] text-2xl font-bold font-serif mb-4 group-hover:text-[#1B6CA8] transition-colors">Tailored Subscriptions</h3>
                  <p className="text-[#414750] text-base mb-8 flex-grow">
